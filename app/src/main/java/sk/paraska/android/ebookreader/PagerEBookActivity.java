...
public class PagerEBookActivity extends AppCompatActivity {
    ...
    private void createNotification() throws IOException {
        ...
        Intent intent = new Intent(getApplicationContext(), PagerEBookActivity.class);
        ...
        Notification notification = new NotificationCompat.Builder(this)
                ...
                .setContentText(chapter + ". part")
                .setSmallIcon(android.R.drawable.ic_popup_reminder)
                .setLargeIcon(BitmapFactory.decodeStream(book.getCoverImage().getInputStream()))
                .setAutoCancel(true)
